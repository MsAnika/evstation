...
import RequestedChargingFlow, {
  HomeRegistrationScreen,
} from "./pages/charging/RequestedChargingFlow";
...
const pageRoutes = {
  ...
  "fleet-registration": "/fleet-register",
  "home-registration": "/home-register",
  verification: "/verify",
  journey: "/match",
  nodes: "/nodes",
  settlement: "/wallet",
...
function pageForPath(pathname) {
  return routePages[pathname] || "login";
}
...
function App() {
  ...
  const [verificationBackPage, setVerificationBackPage] =
  ...
  const setPage = (nextPage) =>
    navigate(nextPage === "dashboard" ? "mobile" : nextPage);
  ...
  if (page === "login")
    return (
      <Login
        onComplete={({ method, mobile }) => {
          if (method === "mobile") {
            setVerificationPhone(mobile);
            setVerificationBackPage("login");
    ...
    return (
      <Registration
        ...
        onComplete={(phone) => {
          ...
          setVerificationBackPage("registration");
          navigate("verification");
        }}
      />
    );
  if (page === "fleet-registration")
    return (
      <FleetRegistration
        onBack={() => navigate("signup")}
        onComplete={(phone) => {
          setVerificationPhone(phone);
          setVerificationBackPage("fleet-registration");
          navigate("verification");
        }}
      />
    );
  if (page === "home-registration")
    return (
      <HomeRegistrationScreen
        onBack={() => navigate("signup")}
  ...
  if (page === "verification")
    return (
      <Verification
        ...
        onBack={() => navigate(verificationBackPage)}
        onComplete={() => navigate("mobile")}
      />
    );
    ...
    <main className="app-shell">
      <header className="topbar">
        ...
        <div>
          ...
          <h1>
            VoltPulse Clean EV <span>/ Delhi-NCR</span>
          </h1>
        </div>
