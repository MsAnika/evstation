...
function Login({ onComplete, onSignup }) {
  ...
  return <main className="login-page">
    ...
    <header className="login-header"><button className="login-icon-button" aria-label="Go back" onClick={onSignup} type="button">←</button><div className="login-brand"><span>ϟ</span><strong>Charge<span>Karo</span></strong></div><button className="login-icon-button" aria-label="Customer support" type="button">?</button></header>
